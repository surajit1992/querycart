...
$fetch_query = "select * from `".$wpdb->prefix."enquiry_data` where `enquiry_status` = '0' order by `enquiry_id` desc"; //where `userid` = '$user->ID'
$fetch_query_count = "select COUNT(*) from `".$wpdb->prefix."enquiry_data` where `enquiry_status` = '0'";
...
<div class="wrap">
    <h1 class="wp-heading-inline">Unposted Enquiry</h1>
    ...
    {
    	echo "<p><strong>No Unposted Enquiry</strong></p>";
    }
